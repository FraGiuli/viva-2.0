    ...
    <div>
      ...
      <div className="mx-auto md:mt-8" style={{ maxWidth: "1528px" }}>
        ...
        >
          ...
          <div className="w-[100%] md:w-5/6 mt-16">
        ...
        <div className="flex gap-8 md:gap-12 flex-col md:flex-row items-center justify-center my-16 md:my-32 px-8">
          <Card isHoverable css={{ mw: "400px" }} className="card-menu">
            <a
        ...
        >
          {selectedLanguage === "it" && (
            <Card isHoverable className="card-menu boxes">
          ...
          <Card isHoverable className="card-menu boxes max-w-[550px] mx-auto">
            <a href="https://www.shopify.com/" target="_blank">
              <Card.Image
