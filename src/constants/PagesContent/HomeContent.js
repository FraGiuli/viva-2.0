...
export const HOME_CONTENT = {
  it: {
      ...
      array: [
        {
          ...
          location: "MILANO",
          srcLogo: "home/logo-viva-grande.png",
          alt: "Viva",
    ...
    work: {
      ...
      body: "VIVA è più di un'azienda, è una **famiglia** in continua espansione.<br> Se hai talento, grinta e determinazione e sei in cerca di un' **opportunità** invia un curriculum o vieni a conoscerci.",
      calltoaction: "> Scopri di più <",
