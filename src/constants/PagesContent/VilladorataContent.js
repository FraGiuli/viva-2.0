export const VILLADORATA_CONTENT = {
  it: {
    ...
    contatti: {
      ...
      orari: "**Riapertura stagionale aprile 2025**",
    },
    prenota: "PRENOTA",
  ...
  en: {
    ...
    bodyhead:
      "Respect for the raw material, sustainability, the valorization of a territory and its biodiversity, are the principles of Viviana Varese's cuisine also in Noto.",
    body1:
      "Among the hills of the Val di Noto, halfway between the city with its churches, noble palaces and the countryside, is Country House Villadorata, within an estate that extends for 25 hectares, immersed in olive groves, almond groves, citrus groves and a small vineyard. The attention to the land starts from the use of the recovered prunings of citrus, olive and almond trees as wood for the fire and for the new kitchen of the open-plan restaurant, both inside, with the new room overlooking the surrounding countryside, than outside. <br><br>  All the fruits of the Villadorata trees become juices, extracts and candied fruit to be offered at breakfast and in the rooms.",
    body2:
    ...
    contatti: {
      ...
      orari: "**Seasonal reopening April 2025**",
    },
    prenota: "BOOKING",
